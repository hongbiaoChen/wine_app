...
<head>
	...
	<link rel="stylesheet" href="/index/css/drinking.css">
	<link rel="stylesheet" href="/index/css/idangerous.swiper.css">
	<link rel="stylesheet" href="/index/css/dropload.css">
</head>
<body>
	<header id = "top">
		<div class = "top">
		...
		<div class = "hotshop">
			<p>热门品牌</p>
			<div  class = "hotbrand">
				<div class = "swiper-wrapper" id = "hotbrandInsize">
					<!-- <div href="#" class="swiper-slide ">
						<a><img src="/index/deliciousDrink_images/logo1@2x.png" alt=""></a>
					</div>
					<div href="#" class="swiper-slide ">
						<a><img src="/index/deliciousDrink_images/logo2@2x.png" alt=""></a>
					</div>
					<div href="#" class="swiper-slide ">
						<a><img src="/index/deliciousDrink_images/logo3@2x.png" alt=""></a>
					</div>
					<div href="#" class="swiper-slide ">
						<a><img src="/index/deliciousDrink_images/logo4@2x.png" alt=""></a>
					</div>
					<div href="#"  class="swiper-slide ">
						<a><img src="/index/deliciousDrink_images/logo5@2x.png" alt=""></a>
					</div> -->
				</div>
			</div>
		</div>
	...
	<footer id="footer">
		<!-- <iframe frameborder=0 border=0 src="footer.html" mce_src="footer.html"></iframe>  -->
      <!-- <div class = "footnav">
         <div>
	...
	<script src = "/index/js/dropload.min.js"></script>
	<script src = "/index/js/drinking.js"></script>
</body>
</html>