            ...
            for(var i = 0;i<result.data.info.length;i++){
                ...
                <div class = "likeGuest lf">
                    <div class = "likeIn">
                        ...
                        <p>
                            200 人已付款
                            <span class = "morelike" data-toggle = "item" href = "likeInMask${LikeIndex}"><img src="/index/img/images/264704695580947598.png" alt=""></span>
                        </p>
                    </div>
                    <!-- 遮罩层 -->
...
$(function(){
    $("#footer").load('footer.html',function(){
        //console.log("success");
        $(".shouye").attr("src","/index/img/images/599877663744535913.png");
